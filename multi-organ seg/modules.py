...
class FeatureAlignmentModule:
    def __init__(self, num_filter):
        self.conv_layer_1 = Conv2D(num_filter, kernel_size=(1, 1), strides=[1, 1], activation=None,
                                                   trainable=True, use_bias=False, name='FA_conv1')
        self.conv_layer_2 = Conv2D(num_filter, kernel_size=(1, 1), strides=[1, 1], activation=None,
                                                   trainable=True, use_bias=False, name='FA_conv2')
        self.upsampling_layer_1 = BilinearUpsampling(output_size=(512,512))
        self.upsampling_layer_2 = BilinearUpsampling(output_size=(512,512))

    def call(self, input_tensor1, input_tensor2):
        output_11 = self.upsampling_layer_1(input_tensor1)
        output_1 = self.conv_layer_1(output_11)
        output_22 = self.upsampling_layer_1(input_tensor2)
        output_2 = self.conv_layer_2(output_22)
    ...
    def block_loss(t_o, s_o, t_weight, s_weight):
        ...
        total_loss = loss_1 + loss_reg_t + loss_reg_s
